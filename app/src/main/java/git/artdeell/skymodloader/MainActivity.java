...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnLive = findViewById(R.id.mm_launch_live);
        Button btnChplay = findViewById(R.id.mm_launch_chplay);
        Button btnHuawei = findViewById(R.id.mm_launch_huawei);
        Button btnNetease = findViewById(R.id.mm_launch_netease);
        if (btnLive != null) btnLive.setOnClickListener(v -> launchGamePackage("com.tgc.sky.android"));
        if (btnChplay != null) btnChplay.setOnClickListener(v -> launchGamePackage("com.tgc.sky.vn.android"));
        if (btnHuawei != null) btnHuawei.setOnClickListener(v -> launchGamePackage("com.tgc.sky.android.huawei"));
        if (btnNetease != null) btnNetease.setOnClickListener(v -> launchGamePackage("com.netease.sky"));
      
      }
      
    private void launchGamePackage(String packageName) {
    SKY_PACKAGE_NAME = packageName;
    sharedPreferences.edit().putString("sky_package_name", SKY_PACKAGE_NAME).apply();
    loadGame();
}
